...
function(get_hash_for_ref ref out_var err_var)
  execute_process(
    COMMAND "P:/Git/Git/cmd/git.exe" --git-dir=.git rev-parse "${ref}^0"
...
execute_process(
  COMMAND "P:/Git/Git/cmd/git.exe" --git-dir=.git show-ref "main"
  WORKING_DIRECTORY "A:/NumberChangeTool/build/_deps/googletest-src"
...
if(fetch_required)
  ...
  execute_process(
    COMMAND "P:/Git/Git/cmd/git.exe" --git-dir=.git fetch --tags --force "origin"
    WORKING_DIRECTORY "A:/NumberChangeTool/build/_deps/googletest-src"
...
if(git_update_strategy MATCHES "^REBASE(_CHECKOUT)?$")
  ...
  execute_process(
    COMMAND "P:/Git/Git/cmd/git.exe" --git-dir=.git symbolic-ref -q HEAD
    WORKING_DIRECTORY "A:/NumberChangeTool/build/_deps/googletest-src"
  ...
  if(current_branch STREQUAL "")
    ...
    execute_process(
      COMMAND "P:/Git/Git/cmd/git.exe" --git-dir=.git for-each-ref "--format=%(upstream:short)" "${current_branch}"
      WORKING_DIRECTORY "A:/NumberChangeTool/build/_deps/googletest-src"
...
execute_process(
  COMMAND "P:/Git/Git/cmd/git.exe" --git-dir=.git status --porcelain
  WORKING_DIRECTORY "A:/NumberChangeTool/build/_deps/googletest-src"
  RESULT_VARIABLE error_code
...
if(need_stash)
  execute_process(
    COMMAND "P:/Git/Git/cmd/git.exe" --git-dir=.git stash save --quiet;--include-untracked
    WORKING_DIRECTORY "A:/NumberChangeTool/build/_deps/googletest-src"
    COMMAND_ERROR_IS_FATAL ANY
  )
endif()
...
if(git_update_strategy STREQUAL "CHECKOUT")
  execute_process(
    COMMAND "P:/Git/Git/cmd/git.exe" --git-dir=.git checkout "${checkout_name}"
    WORKING_DIRECTORY "A:/NumberChangeTool/build/_deps/googletest-src"
    COMMAND_ERROR_IS_FATAL ANY
  )
else()
  execute_process(
    COMMAND "P:/Git/Git/cmd/git.exe" --git-dir=.git rebase "${checkout_name}"
    WORKING_DIRECTORY "A:/NumberChangeTool/build/_deps/googletest-src"
    RESULT_VARIABLE error_code
  ...
  if(error_code)
    ...
    execute_process(
      COMMAND "P:/Git/Git/cmd/git.exe" --git-dir=.git rebase --abort
      WORKING_DIRECTORY "A:/NumberChangeTool/build/_deps/googletest-src"
    )
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      if(need_stash)
        execute_process(
          COMMAND "P:/Git/Git/cmd/git.exe" --git-dir=.git stash pop --index --quiet
          WORKING_DIRECTORY "A:/NumberChangeTool/build/_deps/googletest-src"
          )
      endif()
      message(FATAL_ERROR "\nFailed to rebase in: 'A:/NumberChangeTool/build/_deps/googletest-src'."
    ...
    execute_process(
      COMMAND "P:/Git/Git/cmd/git.exe" --git-dir=.git tag -a
...
if(need_stash)
  ...
  if(error_code)
    ...
    execute_process(
      COMMAND "P:/Git/Git/cmd/git.exe" --git-dir=.git reset --hard --quiet
      WORKING_DIRECTORY "A:/NumberChangeTool/build/_deps/googletest-src"
    )
    execute_process(
      COMMAND "P:/Git/Git/cmd/git.exe" --git-dir=.git stash pop --quiet
      WORKING_DIRECTORY "A:/NumberChangeTool/build/_deps/googletest-src"
      RESULT_VARIABLE error_code
    )
    if(error_code)
      ...
      execute_process(
        COMMAND "P:/Git/Git/cmd/git.exe" --git-dir=.git reset --hard --quiet ${head_sha}
        WORKING_DIRECTORY "A:/NumberChangeTool/build/_deps/googletest-src"
      )
      execute_process(
        COMMAND "P:/Git/Git/cmd/git.exe" --git-dir=.git stash pop --index --quiet
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: 'A:/NumberChangeTool/build/_deps/googletest-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
...
if(init_submodules)
  execute_process(
    COMMAND "P:/Git/Git/cmd/git.exe" --git-dir=.git submodule update --recursive --init 
    WORKING_DIRECTORY "A:/NumberChangeTool/build/_deps/googletest-src"
    COMMAND_ERROR_IS_FATAL ANY
  )
endif()
